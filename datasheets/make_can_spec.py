...
test = [
    ...
    ("LEGACY", "0x133", "BOT", 8, "SOC(u16 permille)", "TEST용 SOC. RUN 0x043과 중복 (미정리)"),
    ("LEGACY", "0x233", "TOP", 8, "SOC(u16 permille)", "TEST용 SOC. 0x133과 완전히 동일 (미정리)"),
...
sheet(wb, "TEST_data (진단)", "BMS CAN ID — TEST data (진단/테스트 온디맨드)",
      ...
      notes=["※ TEST data ID는 PR#31 명세와 완전히 동일 (36행 전부 변경 없음).",
